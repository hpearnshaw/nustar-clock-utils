...
FREQ_CHANGE_DB = {
    ...
    "add": [
        ...
        (1119778399, 173439184, 24000330),
        (1120043394, 173704179, 24000339),
        (1120211427, 173872212, 24000332),
        (1120398127, 174058912, 24000337),
        (1120566156, 174226941, 24000329),
        (1120802641, 174463426, 24000337),
        (1120952016, 174612801, 24000339),
        (1179229092, 232889877, 24000331),
        (1182440359, 236101144, 24000332),
    ],
}
